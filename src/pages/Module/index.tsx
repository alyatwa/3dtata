...
import { OrbitControls, Environment, Lightformer, useEnvironment } from '@react-three/drei'
...
export default function Module() {
 ...
 const ModelGLB = lazy(()=> import(`../../assets/${currentModule!.moduleSource}.tsx`));
  ...
  const classes = useStyles();
   ...
   const cam: any = useControls('Camera', {
  ...
  return (
    ...
    <directionalLight position={[-10, 10, 5]} shadow-mapSize={[256, 256]} shadow-bias={-0.0001} castShadow>
      <orthographicCamera ref={camRef} attach="shadow-camera" args={[-10, 10, -10, 10]} />
    </directionalLight>
    ...
    <div>
      <Panel metadata={currentModule} course={course} sendEvent={(e:any) => makeEvent.current(e)} />
    </div>
