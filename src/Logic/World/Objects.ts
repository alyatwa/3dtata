...
export default class Objects
{
        ...
        this.parsers.items = [
            // Shade
            {
                ...
                apply: (_mesh:any, _options:any) =>
                {
                    ...
                    {
                        material = this.materials.shades.items.white//new THREE.MeshNormalMaterial()
                    }
    ...
    setMerge()
    {
        ...
        this.merge.add = (_name:any, _mesh:any) =>
        {
        ...
        this.merge.applyMerge = () =>
        {
            for(const _mergeItemName in this.merge.items)
            {
                ...
                mergeItem.geometry = THREE.BufferGeometryUtils.mergeBufferGeometries(mergeItem.geometriesToMerge) // Should add original geometry
