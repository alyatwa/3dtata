...
export default class Application
{
     ...
     setDebug()
    {
        ...
        {
            this.debug = new dat.GUI({ width: 250 })
        }
    }  
    ...
    setCamera()
    {
       ...
       this.time.on('tick', () =>
        {
            if(this.world && this.world.AHU)
            {
                this.camera!.target.x = this.world.ahu.chassis.object.position.x
                this.camera!.target.y = this.world.ahu.chassis.object.position.y
            }
        })
    } 
